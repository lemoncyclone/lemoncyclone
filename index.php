...
$doc->addScript('/website/templates/' . $this->template . '/js/bootstrap.min.js', 'text/javascript');
	...
	<header class="header" role="banner">	
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<jdoc:include type="modules" name="top" style="xhtml" /> 
					...
					<a class="brand pull-left" href="<?php echo $this->baseurl; ?>/">		</a>
        ...
        <span class="glyphicon glyphicon-menu-hamburger"></span>
			...
			<?php if ($this->countModules('lang')) : ?> 	
					<div class="header-lang pull-right col-md-2 col-xs-12">
